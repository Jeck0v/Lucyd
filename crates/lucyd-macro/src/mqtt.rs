//! Implementation of the `#[lucyd_mqtt(...)]` attribute macro.
//!
...
/// Parsed arguments for the `#[lucyd_mqtt(...)]` attribute.
pub struct MqttArgs {
...
/// Accumulator for `#[lucyd_mqtt(...)]` arguments as they're parsed.
///
...
/// Expands the `#[lucyd_mqtt(...)]` attribute.
///
    ...
    let expanded = quote! {
        ...
        ::lucyd::_private::inventory::submit! {
            ::lucyd::_private::lucyd_types::endpoint::EndpointMetaStatic {
                name:              #fn_name,
                path:              #topic,
                protocol:          ::lucyd::_private::lucyd_types::endpoint::Protocol::Mqtt,
