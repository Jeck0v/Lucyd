//! Implementation of the `#[lucyd_ws(...)]` attribute macro.
//!
...
/// Parsed arguments for the `#[lucyd_ws(...)]` attribute.
pub struct WsArgs {
...
/// Accumulator for `#[lucyd_ws(...)]` arguments as they're parsed.
///
...
/// Expands the `#[lucyd_ws(...)]` attribute.
///
    ...
    let expanded = quote! {
        ...
        ::lucyd::_private::inventory::submit! {
            ::lucyd::_private::lucyd_types::endpoint::EndpointMetaStatic {
                name:              #fn_name,
                path:              #path,
                protocol:          ::lucyd::_private::lucyd_types::endpoint::Protocol::WebSocket,
